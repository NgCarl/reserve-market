...
- **Résilience** (étape 9, §7) :
  ...
  - Hors ligne, les actions ne sont **pas mises en file** : elles échouent avec un message, pour ne jamais rejouer un changement de statut périmé. La saisie serveur garde son panier et sa clé d'idempotence : « Envoyer » au retour du réseau ne crée pas de doublon.
