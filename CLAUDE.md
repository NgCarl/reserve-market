...
- **Tableau de bord et commandes du jour** (`/api/gestion/*`, ADMIN, lecture seule ; `src/services/gestion.service.ts`) :
  ...
  - **Total encaissé** : somme des commandes dont `encaisseeAt` tombe ce jour-là, même passées la veille. Il reste à 0 tant que l'étape 8 n'existe pas, puisque seul le serveur encaisse.
